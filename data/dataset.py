...
class FedISIC(Dataset):
    ...
    def __getitem__(self, idx:int):
        img_path = '/kaggle/input/datasets/varunramawat/fedisicdataset/FedISIC_npy/{}.npy'.format(self.data_list.iloc[idx,0])   # image
...
class Camelyon(Dataset):
    ...
    def __getitem__(self, idx:int):
        img_path = os.path.join('/kaggle/input/datasets/varunramawat/fedcamelyondataset/FedCamelyon/', self.data_list[0][idx])
