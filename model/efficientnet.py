...
class EfficientNetB0(nn.Module):
    def __init__(self, num_classes = 8, pretrained = True):
        ...
        #self.efficientnet = timm.create_model('efficientnet_b0', pretrained=False, checkpoint_path='/home/ylyan/FEAL/model/efficientnet_b0_ra-3dd342df.pth')
...
class DENSENET121(nn.Module):
    def __init__(self, num_classes = 8, pretrained = True):
        ...
        self.efficientnet = timm.create_model('densenet121.tv_in1k', pretrained=True)
